...
#SBATCH -J 1_VQSR_Annotate_Chr14
...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr14.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr14.err
...
-V PS_Chapter1_Chr14_allChunks.vcf.gz \
-O PS_Chapter1_Chr14_allChunks_annotated.vcf.gz \
