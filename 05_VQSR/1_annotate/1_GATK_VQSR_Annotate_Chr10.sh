...
#SBATCH -J 1_VQSR_Annotate_Chr10
...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr10.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr10.err
...
-V PS_Chapter1_Chr10_allChunks.vcf.gz \
-O PS_Chapter1_Chr10_allChunks_annotated.vcf.gz \
