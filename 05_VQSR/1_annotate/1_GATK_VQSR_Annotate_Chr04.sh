...
#SBATCH -J 1_VQSR_Annotate_Chr04
...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr04.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr04.err
...
-V PS_Chapter1_Chr04_allChunks.vcf.gz \
-O PS_Chapter1_Chr04_allChunks_annotated.vcf.gz \
