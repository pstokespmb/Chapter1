...
#SBATCH -J 7_GATK_VQSR_training_G4
...
#SBATCH --mem=512000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_GATK_VQSR_training_G4.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_GATK_VQSR_training_G4.err
...
-O PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G4.recal \
-tranche 99 -tranche 95 -tranche 92 -tranche 90 \
--tranches-file PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G4.tranches \
--rscript-file PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G4.plots.R