...
-O PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G8.recal \
-tranche 99 -tranche 95 -tranche 92 -tranche 90 \
--tranches-file PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G8.tranches \
--rscript-file PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G8.plots.R