...
#SBATCH -J 2_VQSR_biallelicOnly_Chr14
...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/2_VQSR_biallelicOnly_Chr14.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/2_VQSR_biallelicOnly_Chr14.err
...
-O PS_Chapter1_Chr14_allChunks_annotated_biallelicSNPSOnly.vcf.gz