...
#SBATCH -J fastSTRUCTURE_RUN_noED_noLowCov_annuusOnly_noTexanus_noIntraInterAdmix_noBadMexCult_wMexWild_D4_G2_M5_LD
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/fastSTRUCTURE_RUN_noED_noLowCov_annuusOnly_noTexanus_noIntraInterAdmix_noBadMexCult_wMexWild_D4_G2_M5_LD.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/fastSTRUCTURE_RUN_noED_noLowCov_annuusOnly_noTexanus_noIntraInterAdmix_noBadMexCult_wMexWild_D4_G2_M5_LD.err
...
fastStructureName_fromPlink="Chapter1_allChrom_noRR_NF_noED_noLowCov_annuusOnly_noTexanus_noIntraInterAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned"
fastStructureOut_name="Chapter1_allChrom_noRR_NF_noED_noLowCov_annuusOnly_noTexanus_noIntraInterAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned"
