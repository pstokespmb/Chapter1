...
x_spacing[4] <- 36.5#TV_mex
x_spacing[5] <- 42#TV_sw
x_spacing[6] <- 47#TV_ethno
x_spacing[7] <- 55.5#MO
x_spacing[8] <- 66.5#OK
x_spacing[9] <- 85#IA
x_spacing[10] <- 125#KS
...
x_spacing[17] <- 202.5#SK
x_spacing[18] <- 213#WY
x_spacing[19] <- 223#TX
x_spacing[20] <- 234#CO
x_spacing[21] <- 250#NM
x_spacing[22] <- 264.5#UT
x_spacing[23] <- 272.5#mexWild
x_spacing[24] <- 281.5#CA
x_spacing[25] <- 292#AZ
x_spacing[26] <- 297.5#NV
