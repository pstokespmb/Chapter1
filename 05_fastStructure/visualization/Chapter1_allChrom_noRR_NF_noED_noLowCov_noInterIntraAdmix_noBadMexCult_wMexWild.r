...
x_spacing[3] <- 30#TV_other
x_spacing[4] <- 37#TV_MX
x_spacing[5] <- 42#TV_sw
x_spacing[6] <- 47.5#TV_ethnographic
x_spacing[7] <- 56#MO
x_spacing[8] <- 66.5#OK
x_spacing[9] <- 84#IA
x_spacing[10] <- 125#KS
x_spacing[11] <- 150.5#AR
x_spacing[12] <- 152#IL
x_spacing[13] <- 154#NB
x_spacing[14] <- 160#ND
x_spacing[15] <- 175#SD
x_spacing[16] <- 190.5#MB
x_spacing[17] <- 202#SK
x_spacing[18] <- 213#WY
x_spacing[19] <- 219.5#arg
x_spacing[20] <- 224#niv
x_spacing[21] <- 228.5#fal
x_spacing[22] <- 232#pet
x_spacing[23] <- 238.5#TX
x_spacing[24] <- 245#texanus
x_spacing[25] <- 252.5#CO
x_spacing[26] <- 270#NM
x_spacing[27] <- 284#UT
x_spacing[28] <- 292#mexWild
x_spacing[29] <- 301#CA
x_spacing[30] <- 311.5#AZ
x_spacing[31] <- 317#NV
