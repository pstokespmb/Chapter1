...
x_spacing[2] <- 19#RHA
x_spacing[3] <- 33#LR
x_spacing[4] <- 45#ethno
x_spacing[5] <- 53#mecCult
x_spacing[6] <- 60#mexWild
x_spacing[7] <- 62.5#ethnoWild
x_spacing[8] <- 70#ED
x_spacing[9] <- 87#IA
x_spacing[10] <- 125#KS
x_spacing[11] <- 175#ND
...
x_spacing[13] <- 190#MO
x_spacing[14] <- 197#NB
x_spacing[15] <- 199.5#IL
x_spacing[16] <- 201.5#AR
x_spacing[17] <- 207#OK
x_spacing[18] <- 217#WY
x_spacing[19] <- 232#SK
x_spacing[20] <- 241#MB
x_spacing[21] <- 247#arg
x_spacing[22] <- 251#pet
x_spacing[23] <- 254#fal
x_spacing[24] <- 260#niv
x_spacing[25] <- 263#texanus
x_spacing[26] <- 270#TX
x_spacing[27] <- 281#CA
x_spacing[28] <- 292#AZ
x_spacing[29] <- 300#NV
