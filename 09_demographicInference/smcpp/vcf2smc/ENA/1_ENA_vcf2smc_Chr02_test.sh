...
#SBATCH -J 1_ENA_vcf2smc_Chr02_test
...
#SBATCH --mem=42000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/1_ENA_vcf2smc_Chr02_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/1_ENA_vcf2smc_Chr02_test.err
...
for sample in Ann1238_subset ANN1198 IA2W_11 MO1W_33 ann01_cwIA;
    ...
    smc++ vcf2smc \
    --cores 4 \
    --mask /global/scratch/users/peter_stokes/Chapter1/masks_for_smcpp/PS_Chapter1_mask_Chr02_FINAL.bed.gz \
    -d ${sample} ${sample} \
    /global/scratch/users/peter_stokes/Chapter1/VCF_for_smcpp/PS_Chapter1_biallelicSNPS_G4_hardFilteredInvariants_Chr02_sorted.vcf.gz \
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/ENA_${sample}_Chr02_test.smc.gz \
    HanXRQChr02 \
