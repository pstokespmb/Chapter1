...
#SBATCH -J 2_ENA_vcf2smc_Chr01_test
...
#SBATCH --mem=42000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/2_ENA_vcf2smc_Chr01_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/2_ENA_vcf2smc_Chr01_test.err
#SBATCH --mail-user=peter_stokes@berkeley.edu
#SBATCH --mail-type=All

SINGULARITY_CACHEDIR=/global/scratch/users/peter_stokes

for sample in ann04_nwAR ann10_ccIL ann29_neSD ann34_cwKS ann39_ncNE;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/ENA_${sample}_Chr01_test.smc.gz \
    HanXRQChr01 \
