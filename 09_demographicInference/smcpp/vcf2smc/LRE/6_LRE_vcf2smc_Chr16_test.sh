...
#SBATCH -J 3_LRE_vcf2smc_Chr16_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_LRE_vcf2smc_Chr16_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_LRE_vcf2smc_Chr16_test.err
