...
#SBATCH -J 4_LRE_vcf2smc_Chr17_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/4_LRE_vcf2smc_Chr17_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/4_LRE_vcf2smc_Chr17_test.err
