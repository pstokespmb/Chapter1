...
#SBATCH -J 4_LRE_vcf2smc_Chr02_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/4_LRE_vcf2smc_Chr02_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/4_LRE_vcf2smc_Chr02_test.err
...
for sample in Havasupai Laguna_Pueblo Hopi_real_NEW;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/LRE_${sample}_Chr02_test.smc.gz \
    HanXRQChr02 \
