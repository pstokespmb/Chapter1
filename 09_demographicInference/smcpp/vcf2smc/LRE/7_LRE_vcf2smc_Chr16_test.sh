...
#SBATCH -J 7_LRE_vcf2smc_Chr16_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr16_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr16_test.err
...
for sample in Havasupai Laguna_Pueblo Hopi_real_NEW;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/LRE_${sample}_Chr16_test.smc.gz \
    HanXRQChr16 \
