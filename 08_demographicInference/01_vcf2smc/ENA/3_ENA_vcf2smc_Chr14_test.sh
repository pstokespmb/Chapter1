...
#SBATCH -J 3_ENA_vcf2smc_Chr14_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_ENA_vcf2smc_Chr14_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_ENA_vcf2smc_Chr14_test.err
...
for sample in Ann1238_subset ann04_nwAR;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/ENA_${sample}_Chr14_test.smc.gz \
    HanXRQChr14 \
