...
#SBATCH -J 2_ENA_vcf2smc_Chr09_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/2_ENA_vcf2smc_Chr09_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/2_ENA_vcf2smc_Chr09_test.err
