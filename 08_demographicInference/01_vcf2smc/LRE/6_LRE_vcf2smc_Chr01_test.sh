...
#SBATCH -J 6_LRE_vcf2smc_Chr01_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/6_LRE_vcf2smc_Chr01_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/6_LRE_vcf2smc_Chr01_test.err
