...
#SBATCH -J 7_LRE_vcf2smc_Chr12_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr12_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr12_test.err
