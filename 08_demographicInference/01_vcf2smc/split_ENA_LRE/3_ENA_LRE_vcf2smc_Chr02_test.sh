...
#SBATCH -J 3_ENA_LRE_vcf2smc_Chr02_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_ENA_LRE_vcf2smc_Chr02_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_ENA_LRE_vcf2smc_Chr02_test.err
