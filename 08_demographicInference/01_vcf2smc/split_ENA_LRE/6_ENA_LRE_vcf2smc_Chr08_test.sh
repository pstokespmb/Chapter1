...
#SBATCH -J 6_ENA_LRE_vcf2smc_Chr08_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/6_ENA_LRE_vcf2smc_Chr08_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/6_ENA_LRE_vcf2smc_Chr08_test.err
