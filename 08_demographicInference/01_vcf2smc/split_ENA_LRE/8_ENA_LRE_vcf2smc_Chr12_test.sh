...
#SBATCH -J 8_ENA_LRE_vcf2smc_Chr12_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/8_ENA_LRE_vcf2smc_Chr12_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/8_ENA_LRE_vcf2smc_Chr12_test.err
