...
#SBATCH -J 2_ENA_LRE_vcf2smc_Chr11_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/2_ENA_LRE_vcf2smc_Chr11_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/2_ENA_LRE_vcf2smc_Chr11_test.err
...
for sample in Ann1238_subset;
    ...
    smc++ vcf2smc \
    --cores 1 \
    --mask /global/scratch/users/peter_stokes/Chapter1/masks_for_smcpp/InversionRegions_Chr11.bed.gz \
    -d ${sample} ${sample} \
    /global/scratch/users/peter_stokes/Chapter1/VCF_for_smcpp/PS_Chapter1_biallelicSNPS_G4_hardFilteredInvariants_Chr11_missingPosReplaced_sorted.vcf.gz \
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/ENA_LRE_${sample}_Chr11_test.smc.gz \
    HanXRQChr11 \
