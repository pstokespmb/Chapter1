...
#SBATCH -J 3_LRE_ENA_vcf2smc_Chr06_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_LRE_ENA_vcf2smc_Chr06_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_LRE_ENA_vcf2smc_Chr06_test.err
...
for sample in Mandan1_PPN046;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/LRE_ENA_${sample}_Chr06_test.smc.gz \
    HanXRQChr06 \
