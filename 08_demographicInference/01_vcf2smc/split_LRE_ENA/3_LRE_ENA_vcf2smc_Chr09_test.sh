...
#SBATCH -J 3_LRE_ENA_vcf2smc_Chr09_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_LRE_ENA_vcf2smc_Chr09_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_LRE_ENA_vcf2smc_Chr09_test.err
...
for sample in Mandan1_PPN046;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/LRE_ENA_${sample}_Chr09_test.smc.gz \
    HanXRQChr09 \
