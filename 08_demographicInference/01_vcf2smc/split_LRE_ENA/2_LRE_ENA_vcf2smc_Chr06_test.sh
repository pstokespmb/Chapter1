...
#SBATCH -J 2_LRE_ENA_vcf2smc_Chr06_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/2_LRE_ENA_vcf2smc_Chr06_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/2_LRE_ENA_vcf2smc_Chr06_test.err
