...
#SBATCH -J 6_LRE_ENA_vcf2smc_Chr01_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/6_LRE_ENA_vcf2smc_Chr01_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/6_LRE_ENA_vcf2smc_Chr01_test.err
