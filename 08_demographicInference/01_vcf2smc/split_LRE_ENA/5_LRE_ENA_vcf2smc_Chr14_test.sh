...
#SBATCH -J 5_LRE_ENA_vcf2smc_Chr14_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/5_LRE_ENA_vcf2smc_Chr14_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/5_LRE_ENA_vcf2smc_Chr14_test.err
