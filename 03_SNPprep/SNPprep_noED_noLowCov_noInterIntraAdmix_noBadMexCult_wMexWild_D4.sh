...
#SBATCH -J SNPprep_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/SNPprep_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/SNPprep_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4.err
...
#--out ${plinkOuts_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD
#
####third plink conversion
#
#plink2 --allow-extra-chr --bfile ${plinkOuts_path}/${samplesRemovedVCF_name}_D4_Bi_plinked \
#--extract ${plinkOuts_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD.prune.in \
#--make-bed --out ${plinkOuts_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned
#
####editing .bim file for fastStructure (fastStructure gets upset about non-pure-numerical chromosome names)
#
#sed -i 's/HanXRQChr0//g' ${plinkOuts_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned.bim
#sed -i 's/HanXRQChr//g' ${plinkOuts_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned.bim
#
###producing VCF for PCA and D-stats
#
#plink2 --bfile ${plinkOuts_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned --recode vcf --allow-extra-chr --out ${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure

##gotta change the VCF header version. Same difference, except VCFtools throws an error for v4.3

#sed -i 's/VCFv4.3/VCFv4.2/g' ${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure.vcf


#stats

#${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure

vcftools --gzvcf ${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure.vcf --depth --out ${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure
vcftools --gzvcf ${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure.vcf --site-mean-depth --out ${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure
vcftools --gzvcf ${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure.vcf --missing-indv --out ${startingVCF_path}/${samplesRemovedVCF_name}_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure
