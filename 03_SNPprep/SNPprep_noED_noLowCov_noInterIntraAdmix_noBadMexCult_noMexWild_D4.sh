...
#SBATCH -J SNPprep_noED_noLowCov_noInterIntraAdmix_noBadMexCult_noMexWild_D4
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/SNPprep_noED_noLowCov_noInterIntraAdmix_noBadMexCult_noMexWild_D4.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/SNPprep_noED_noLowCov_noInterIntraAdmix_noBadMexCult_noMexWild_D4.err
