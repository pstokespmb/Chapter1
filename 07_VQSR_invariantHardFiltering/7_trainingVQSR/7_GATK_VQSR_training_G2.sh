...
#SBATCH -J 7_GATK_VQSR_training_G2
...
#SBATCH --mem=512000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_GATK_VQSR_training_G2.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_GATK_VQSR_training_G2.err
...
-V PS_Chapter1_allChrom_annotated_biallelicSNPSOnly.vcf.gz \
-an QD -an MQ -an MQRankSum -an ReadPosRankSum -an FS -an SOR -an DP -an InbreedingCoeff \
--max-gaussians 2 \
-mode SNP \
--resource:3callerscombined,known=false,training=true,truth=true,prior=10.0 truth_GATK.vcf \
-O PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G2.recal \
-tranche 99 -tranche 95 -tranche 92 -tranche 90 \
--tranches-file PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G2.tranches \
--rscript-file PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_G2.plots.R