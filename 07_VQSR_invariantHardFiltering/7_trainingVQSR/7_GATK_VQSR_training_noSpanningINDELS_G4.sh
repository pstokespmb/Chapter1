...
#SBATCH -J 7_GATK_VQSR_training_noSpanningINDELS_G4
...
#SBATCH --mem=512000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_GATK_VQSR_training_noSpanningINDELS_G4.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_GATK_VQSR_training_noSpanningINDELS_G4.err
...
#bcftools view -e'ALT="*" || type!="snp"' PS_Chapter1_allChrom_annotated_biallelicSNPSOnly.vcf.gz > PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_noSpanningINDELS.vcf

mv PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_noSpanningINDELS.vcf.gz PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_noSpanningINDELS.vcf

bgzip PS_Chapter1_allChrom_annotated_biallelicSNPSOnly_noSpanningINDELS.vcf
