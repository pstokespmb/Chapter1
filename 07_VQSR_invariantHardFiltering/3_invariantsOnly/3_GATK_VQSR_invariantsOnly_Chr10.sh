...
#SBATCH -J 3_VQSR_invariantsOnly_Chr10
...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_VQSR_invariantsOnly_Chr10.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_VQSR_invariantsOnly_Chr10.err
...
-O PS_Chapter1_Chr10_allChunks_annotated_invariantsOnly.vcf.gz