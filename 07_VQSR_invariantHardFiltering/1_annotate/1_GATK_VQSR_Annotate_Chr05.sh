...
#SBATCH -J 1_VQSR_Annotate_Chr05
...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr05.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr05.err
...
-V PS_Chapter1_Chr05_allChunks.vcf.gz \
-O PS_Chapter1_Chr05_allChunks_annotated.vcf.gz \
