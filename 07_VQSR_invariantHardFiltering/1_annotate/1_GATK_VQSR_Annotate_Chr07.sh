...
#SBATCH -J 1_VQSR_Annotate_Chr07
...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr07.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/1_VQSR_Annotate_Chr07.err
...
-V PS_Chapter1_Chr07_allChunks.vcf.gz \
-O PS_Chapter1_Chr07_allChunks_annotated.vcf.gz \
