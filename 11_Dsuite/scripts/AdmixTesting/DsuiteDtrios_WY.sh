...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_WY.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_WY.err
