...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_1517.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_1517.err
