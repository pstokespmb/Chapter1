...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_1516.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_1516.err
