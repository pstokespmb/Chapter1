...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_SD.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_SD.err
