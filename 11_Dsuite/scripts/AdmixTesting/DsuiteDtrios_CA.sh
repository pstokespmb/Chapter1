...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_CA.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_CA.err
