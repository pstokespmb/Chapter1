...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_261.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_261.err
