...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_1574.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_1574.err
