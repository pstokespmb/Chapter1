...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_ND.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DsuiteDtrios_ND.err
...
Dsuite Dtrios -t ${newick_sets_path}/AdmixTesting_${GeoLoc}_c1.nwk ${startingVCF_path}/${VCF_name}.vcf ${newick_sets_path}/AdmixTesting_${GeoLoc}_c1.txt
Dsuite Dtrios -t ${newick_sets_path}/AdmixTesting_${GeoLoc}_c2.nwk ${startingVCF_path}/${VCF_name}.vcf ${newick_sets_path}/AdmixTesting_${GeoLoc}_c2.txt