...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/Chr13_prepper.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/Chr13_prepper.err
...
grep "HanXRQChr13" ${bedOutput_path}/${vcfOutput_name}_${Chromosome}_missingPositions_sorted_1Based.bed > ${bedOutput_path}/${vcfOutput_name}_${Chromosome}_missingPositions_sorted_1Based_fixed.bed
