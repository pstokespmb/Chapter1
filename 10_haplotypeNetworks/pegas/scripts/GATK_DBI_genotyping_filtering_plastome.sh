#!/bin/bash 
#SBATCH -D /global/scratch2/peter_stokes/plastome_mito_Alignment/plastome/gvcfs
#SBATCH -J GATK_DBI_genotyping_filtering_plastome
...
#SBATCH --mem=64000
#SBATCH -o /global/scratch2/peter_stokes/err_outs/GATK_DBI_genotyping_filtering_plastome.out
#SBATCH -e /global/scratch2/peter_stokes/err_outs/GATK_DBI_genotyping_filtering_plastome.err
...
--genomicsdb-workspace-path /global/scratch2/peter_stokes/plastome_mito_Alignment/plastome/DBI_plastome \
--reader-threads 12 \
--batch-size 75 \
-L HanXRQCP \
-R /global/scratch2/peter_stokes/references/HanXRQr2.0-SUNRISE-2.1.genome.CP.fasta \
...
-R /global/scratch2/peter_stokes/references/HanXRQr2.0-SUNRISE-2.1.genome.CP.fasta \
-V gendb:////global/scratch2/peter_stokes/plastome_mito_Alignment/plastome/DBI_plastome \
-L HanXRQCP \
-O /global/scratch2/peter_stokes/plastome_mito_Alignment/plastome/vcf/GATK_plastome_raw_1.vcf
...
-R /global/scratch2/peter_stokes/references/HanXRQr2.0-SUNRISE-2.1.genome.CP.fasta \
-O /global/scratch2/peter_stokes/plastome_mito_Alignment/plastome/vcf/GATK_plastome_filtered_mapQ30_2.vcf \
--variant /global/scratch2/peter_stokes/plastome_mito_Alignment/plastome/vcf/GATK_plastome_raw_1.vcf \
...
srun vcftools --vcf /global/scratch2/peter_stokes/plastome_mito_Alignment/plastome/vcf/GATK_plastome_filtered_mapQ30_2.vcf --recode --remove-indels --remove-filtered-all --minQ 1000.0 --out /global/scratch2/peter_stokes/plastome_mito_Alignment/plastome/vcf/GATK_plastome_filtered_mapQ30_SNPs_3