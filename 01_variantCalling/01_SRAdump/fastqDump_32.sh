...
#SBATCH --mem=38000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/SRA_dump_32.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/SRA_dump_32.err
