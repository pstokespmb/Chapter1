...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_geno_Chr02_L1.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_geno_Chr02_L1.err
...
-O /global/scratch/users/peter_stokes/Chapter1/VariantCalling/VCF_outs_raw/PS_Chapter1_Chr02_L1.vcf.gz \
-L  HanXRQChr02:1-1500000 \
