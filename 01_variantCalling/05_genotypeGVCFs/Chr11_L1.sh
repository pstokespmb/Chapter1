...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_geno_Chr11_L1.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_geno_Chr11_L1.err
...
-O /global/scratch/users/peter_stokes/Chapter1/VariantCalling/VCF_outs_raw/PS_Chapter1_Chr11_L1.vcf.gz \
-L  HanXRQChr11:1-1500000 \
