...
#SBATCH --mem=48000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_41_Chrom_6.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_41_Chrom_6.err
