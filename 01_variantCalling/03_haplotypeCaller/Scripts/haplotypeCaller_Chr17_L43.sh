...
#SBATCH --mem=48000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_43_Chrom_17.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_43_Chrom_17.err
