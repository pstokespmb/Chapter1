...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_66_Chrom_3.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_66_Chrom_3.err
