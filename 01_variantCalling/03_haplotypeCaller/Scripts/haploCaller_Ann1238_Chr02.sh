...
#SBATCH -J haploCaller_Ann1238_Chr02
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr02.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr02.err
...
-L HanXRQChr02 \
-O /global/scratch/users/peter_stokes/Chapter1/VariantCalling/gVCFs_new/unsorted/Ann1238_Chr02.g.vcf.gz --ERC GVCF