...
#SBATCH -J haploCaller_Ann1238_Chr03
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr03.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr03.err
...
-L HanXRQChr03 \
-O /global/scratch/users/peter_stokes/Chapter1/VariantCalling/gVCFs_new/unsorted/Ann1238_Chr03.g.vcf.gz --ERC GVCF