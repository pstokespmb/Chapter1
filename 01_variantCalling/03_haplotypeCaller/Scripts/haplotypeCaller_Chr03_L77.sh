...
#SBATCH --mem=96000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_77_Chrom_3.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_77_Chrom_3.err
