...
#SBATCH -J haploCaller_Ann1238_Chr17
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr17.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr17.err
...
-L HanXRQChr17 \
-O /global/scratch/users/peter_stokes/Chapter1/VariantCalling/gVCFs_new/unsorted/Ann1238_Chr17.g.vcf.gz --ERC GVCF