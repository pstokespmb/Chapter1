...
#SBATCH -J haploCaller_Ann1238_Chr16
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr16.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr16.err
...
-L HanXRQChr16 \
-O /global/scratch/users/peter_stokes/Chapter1/VariantCalling/gVCFs_new/unsorted/Ann1238_Chr16.g.vcf.gz --ERC GVCF