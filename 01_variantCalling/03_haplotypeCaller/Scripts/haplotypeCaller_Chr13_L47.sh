...
#SBATCH --mem=48000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_47_Chrom_13.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_47_Chrom_13.err
