...
#SBATCH --mem=128000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_67_Chrom_17.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_67_Chrom_17.err
