...
#SBATCH --mem=48000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_73_Chrom_3.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_73_Chrom_3.err
