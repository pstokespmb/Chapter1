...
#SBATCH -J haploCaller_Ann1238_Chr04
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr04.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/haploCaller_Ann1238_Chr04.err
...
-L HanXRQChr04 \
-O /global/scratch/users/peter_stokes/Chapter1/VariantCalling/gVCFs_new/unsorted/Ann1238_Chr04.g.vcf.gz --ERC GVCF