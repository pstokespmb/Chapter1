...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_1_Chrom_13_3.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_1_Chrom_13_3.err
