...
#SBATCH --mem=48000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_61_Chrom_1.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_61_Chrom_1.err
