...
#SBATCH --mem=48000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_8_Chrom_9.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_8_Chrom_9.err
