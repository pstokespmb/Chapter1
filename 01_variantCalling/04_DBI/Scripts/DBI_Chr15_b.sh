...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr15_b.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr15_b.err
#SBATCH --mail-user=peter_stokes@berkeley.edu
#SBATCH --mail-type=All

module load java

#rm -r /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr15_b
...
#GenomicsDBImport \
#--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr15_b \
#--reader-threads 6 \
#--batch-size 50 \
#-L HanXRQChr15:70500001-141000000 \
...
--genomicsdb-update-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr15_b