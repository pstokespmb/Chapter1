...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr12_c.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr12_c.err
...
#GenomicsDBImport \
#--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr12_c \
#--reader-threads 32 \
#--batch-size 50 \
#-L HanXRQChr12:141000001-163781230 \
...
--genomicsdb-update-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr12_c