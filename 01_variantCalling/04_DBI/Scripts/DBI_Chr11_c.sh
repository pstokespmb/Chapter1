...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr11_c.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr11_c.err
...
#GenomicsDBImport \
#--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr11_c \
#--reader-threads 6 \
#--batch-size 50 \
#-L HanXRQChr11:141000001-189830405 \
...
--genomicsdb-update-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr11_c
