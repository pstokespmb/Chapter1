...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr13_f.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr13_f.err
...
GenomicsDBImport \
--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr13_f \
--reader-threads 6 \
--batch-size 50 \
-L HanXRQChr13:72000001-108000000 \
