...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr09_b.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr09_b.err
...
#GenomicsDBImport \
#--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr09_b \
#--reader-threads 6 \
#--batch-size 50 \
#-L HanXRQChr09:70500001-141000000 \
...
--genomicsdb-update-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr09_b