...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr01_a.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr01_a.err
...
#GenomicsDBImport \
#--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr01_a \
#--reader-threads 6 \
#--batch-size 50 \
#-L HanXRQChr01:1-70500000 \
...
--genomicsdb-update-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr01_a
