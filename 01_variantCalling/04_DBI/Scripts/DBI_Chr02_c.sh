...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr02_c.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr02_c.err
...
#GenomicsDBImport \
#--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr02_c \
#--reader-threads 6 \
#--batch-size 50 \
#-L HanXRQChr02:141000001-174800439 \
...
--genomicsdb-update-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr02_c
