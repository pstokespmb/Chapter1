...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr13_e.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr13_e.err
...
GenomicsDBImport \
--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr13_e \
--reader-threads 6 \
--batch-size 50 \
-L HanXRQChr13:36000001-72000000 \
