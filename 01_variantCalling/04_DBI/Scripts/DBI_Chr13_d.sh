...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr13_d.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr13_d.err
...
GenomicsDBImport \
--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr13_d \
--reader-threads 6 \
--batch-size 50 \
-L HanXRQChr13:1-36000000 \
