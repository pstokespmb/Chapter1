...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/DBI_Chr15_c.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/DBI_Chr15_c.err
#SBATCH --mail-user=peter_stokes@berkeley.edu
#SBATCH --mail-type=All

module load java

#rm -r /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr15_c
...
#GenomicsDBImport \
#--genomicsdb-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr15_c \
#--reader-threads 6 \
#--batch-size 50 \
#-L HanXRQChr15:141000001-175671323 \
...
--genomicsdb-update-workspace-path /global/scratch/users/peter_stokes/Chapter1/VariantCalling/DBI/DBI_outs/DBI_Chr15_c