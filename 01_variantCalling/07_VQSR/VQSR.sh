...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VQSR.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VQSR.err
...
#-R /global/scratch/users/peter_stokes/references/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
#-V ${VQSRInputPath}/PS_Chapter1_allChrom_VQSRInput.vcf.gz \
#-O ${VQSROutputPath}/PS_Chapter1_allChrom_VQSROutput_G4.vcf.gz \
#-ts-filter-level 99.0 \
#--tranches-file ${VQSROutputPath}/PS_Chapter1_allChrom_VQSRready_G4.tranches \
#--recal-file ${VQSROutputPath}/PS_Chapter1_allChrom_VQSRready_G4.recal \
#--exclude-filtered \
#-mode SNP
#
...
#-R /global/scratch/users/peter_stokes/references/HanXRQr2.0-SUNRISE-2.1.genome.fasta \
#-V ${VQSRInputPath}/PS_Chapter1_allChrom_VQSRInput.vcf.gz \
#-O ${VQSROutputPath}/PS_Chapter1_allChrom_VQSROutput_G6.vcf.gz \
#-ts-filter-level 99.0 \
#--tranches-file ${VQSROutputPath}/PS_Chapter1_allChrom_VQSRready_G6_quick.tranches \
#--recal-file ${VQSROutputPath}/PS_Chapter1_allChrom_VQSRready_G6_quick.recal \
#--exclude-filtered \
#-mode SNP

#bcftools concat -a ${VQSROutputPath}/PS_Chapter1_allChrom_VQSROutput_G6.vcf.gz /global/scratch/users/peter_stokes/Chapter1/VariantCalling/VCFprocessing/PS_Chapter1_allChrom_invariantsOnly_hardFiltered.vcf.gz -Oz -o ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered.vcf.gz

tabix -f -p vcf ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.vcf.gz


remove samples, rename IA2W_17, 
...
#bcftools sort -T /global/scratch/users/peter_stokes/temp_files ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered.vcf.gz -Oz -o ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.vcf.gz
#
#tabix -p -f vcf ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.vcf.gz
#
...
#
#bedtools complement -i ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.vcf.gz -g /global/scratch/users/peter_stokes/Chapter1/masksBeds/ChromosomeLengths.txt > ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered.bed
#
####sort bed output from missing positions bed
#
#sort-bed ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered.bed > ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed
#
####merge sorted bed with InversionRegionsBed
#
#bedops --merge ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed /global/scratch/users/peter_stokes/Chapter1/masksBeds/XRQv2_MappedInversions.bed > ${postVQSRPath}/smcppReady_missingMask_IRmask_allChrom.bed
#
...
#
#bedextract HanXRQChr01 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr01_sorted.bed
#bedextract HanXRQChr02 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr02_sorted.bed
#bedextract HanXRQChr03 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr03_sorted.bed
#bedextract HanXRQChr04 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr04_sorted.bed
#bedextract HanXRQChr05 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr05_sorted.bed
#bedextract HanXRQChr06 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr06_sorted.bed
#bedextract HanXRQChr07 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr07_sorted.bed
#bedextract HanXRQChr08 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr08_sorted.bed
#bedextract HanXRQChr09 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr09_sorted.bed
#bedextract HanXRQChr10 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr10_sorted.bed
#bedextract HanXRQChr11 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr11_sorted.bed
#bedextract HanXRQChr12 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr12_sorted.bed
#bedextract HanXRQChr13 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr13_sorted.bed
#bedextract HanXRQChr14 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr14_sorted.bed
#bedextract HanXRQChr15 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr15_sorted.bed
#bedextract HanXRQChr16 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr16_sorted.bed
#bedextract HanXRQChr17 ${postVQSRPath}/PS_Chapter1_allChrom_VQSROutput_G6_invariantsHardFiltered_sorted.bed > ${postVQSRPath}/smcppReady_missingMask_NoIRmask_Chr17_sorted.bed
#
...
#
####add _G6# when script finishes#
#bcftools query -f '%CHROM %POS\n' ${VQSRInputPath}/PS_Chapter1_allChrom_VQSRInput.vcf.gz > ${VQSRInputPath}/PS_Chapter1_allChrom_VQSRInput.txt
#bcftools query -f '%CHROM %POS\n' ${VQSROutputPath}/PS_Chapter1_allChrom_VQSROutput_G6.vcf.gz > ${VQSROutputPath}/PS_Chapter1_allChrom_VQSROutput_G6.txt
#