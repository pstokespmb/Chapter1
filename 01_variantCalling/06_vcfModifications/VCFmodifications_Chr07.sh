...
#SBATCH -J VCFmodifications_Chr07
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr07.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr07.err
...
#PS_Chapter1_${ChromosomeName}_L100.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
