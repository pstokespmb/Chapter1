...
#SBATCH -J VCFmodifications_Chr04
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr04.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr04.err
...
#PS_Chapter1_${ChromosomeName}_L127.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L128.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L129.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L130.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L131.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L132.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L133.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L134.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L135.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L136.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L137.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L138.vcf.gz \
#PS_Chapter1_${ChromosomeName}_L139.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
