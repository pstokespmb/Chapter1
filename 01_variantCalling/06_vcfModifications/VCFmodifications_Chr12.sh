...
#SBATCH -J VCFmodifications_Chr12
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr12.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr12.err
...
#PS_Chapter1_${ChromosomeName}_L110.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
