...
#SBATCH -J VCFmodifications_Chr02
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr02.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr02.err
...
#PS_Chapter1_${ChromosomeName}_L117.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
