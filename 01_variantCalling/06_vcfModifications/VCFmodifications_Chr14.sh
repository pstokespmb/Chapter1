...
#SBATCH -J VCFmodifications_Chr14
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr14.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr14.err
