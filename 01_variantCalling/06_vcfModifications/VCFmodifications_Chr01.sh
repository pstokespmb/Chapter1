...
#SBATCH -J VCFmodifications_Chr01
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr01.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr01.err
