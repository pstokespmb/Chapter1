...
#SBATCH -J VCFmodifications_Chr17
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr17.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr17.err
...
#PS_Chapter1_${ChromosomeName}_L131.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
