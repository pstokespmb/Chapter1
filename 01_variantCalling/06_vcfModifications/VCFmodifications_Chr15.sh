...
#SBATCH -J VCFmodifications_Chr15
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr15.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr15.err
