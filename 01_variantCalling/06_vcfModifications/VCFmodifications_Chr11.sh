...
#SBATCH -J VCFmodifications_Chr11
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr11.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr11.err
