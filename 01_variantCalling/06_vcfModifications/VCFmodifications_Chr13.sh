...
#SBATCH -J VCFmodifications_Chr13
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr13.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr13.err
...
#PS_Chapter1_${ChromosomeName}_L116.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
