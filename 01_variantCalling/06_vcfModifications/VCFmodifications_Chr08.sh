...
#SBATCH -J VCFmodifications_Chr08
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr08.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr08.err
...
#PS_Chapter1_${ChromosomeName}_L112.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
