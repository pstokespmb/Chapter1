...
#SBATCH -J VCFmodifications_Chr05
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr05.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr05.err
...
#PS_Chapter1_${ChromosomeName}_L119.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
