...
#SBATCH -J VCFmodifications_Chr16
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr16.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr16.err
...
PS_Chapter1_${ChromosomeName}_L138.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
