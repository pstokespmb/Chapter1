...
#SBATCH -J VCFmodifications_Chr06
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr06.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr06.err
...
#PS_Chapter1_${ChromosomeName}_L99.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
