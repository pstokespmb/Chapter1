...
#SBATCH -J VCFmodifications_Chr03
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr03.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr03.err
...
#PS_Chapter1_${ChromosomeName}_L118.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
