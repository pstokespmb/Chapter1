...
#SBATCH -J VCFmodifications_Chr10
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr10.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/VCFmodifications_Chr10.err
...
#PS_Chapter1_${ChromosomeName}_L121.vcf.gz -Oz -o ${concatenatedPath}/PS_Chapter1_${ChromosomeName}_concatenatedRaw.vcf.gz
#
