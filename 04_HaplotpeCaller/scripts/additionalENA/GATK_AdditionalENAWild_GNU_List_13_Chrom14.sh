...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/GATK_13_Chrom_14.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/GATK_13_Chrom_14.err
