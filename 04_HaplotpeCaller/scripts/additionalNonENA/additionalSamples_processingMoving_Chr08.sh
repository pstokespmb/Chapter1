...
#SBATCH -J additionalSamples_processingMoving_Chr08
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/additionalSamples_processingMoving_Chr08.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/additionalSamples_processingMoving_Chr08.err
