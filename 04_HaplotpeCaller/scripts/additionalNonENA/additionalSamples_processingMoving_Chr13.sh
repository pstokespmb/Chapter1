...
#SBATCH -J additionalSamples_processingMoving_Chr13
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/additionalSamples_processingMoving_Chr13.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/additionalSamples_processingMoving_Chr13.err
