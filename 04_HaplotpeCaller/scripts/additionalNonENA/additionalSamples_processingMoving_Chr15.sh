...
#SBATCH -J additionalSamples_processingMoving_Chr15
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/additionalSamples_processingMoving_Chr15.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/additionalSamples_processingMoving_Chr15.err
