...
#SBATCH -J RAxML_prepAndRun_noLowCov_newVersionRAxML_moreData
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/RAxML_prepAndRun_noLowCov_newVersionRAxML_moreData.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/RAxML_prepAndRun_noLowCov_newVersionRAxML_moreData.err
...
#
#python3 /global/scratch/users/peter_stokes/Chapter1/RAxML/scripts/vcf2phylip.py -i ${RAxMLvcfs_path}/${VCFThinnedPrefix_name}_5k.vcf --output-folder ${RAxMLallignments_path} --output-prefix ${VCFThinnedPrefix_name}_5k
#
#python /global/scratch/users/peter_stokes/Chapter1/RAxML/scripts/ascbias.py -p ${RAxMLallignments_path}/${VCFThinnedPrefix_name}_5k.min4.phy -o ${RAxMLallignments_path}/${VCFThinnedPrefix_name}_5k_RAxMLready.min4.phy
