...
#SBATCH -J RAxML_prepAndRun_noLowCov_newVersionRAxML
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/RAxML_prepAndRun_noLowCov_newVersionRAxML.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/RAxML_prepAndRun_noLowCov_newVersionRAxML.err
...
#python3 /global/scratch/users/peter_stokes/Chapter1/RAxML/scripts/vcf2phylip.py -i /global/scratch/users/peter_stokes/Chapter1/RAxML/VCFs/${RAxMLInput_name}.vcf --output-folder ${RAxMLallignments_path} --output-prefix ${RAxMLInput_name}

#python /global/scratch/users/peter_stokes/Chapter1/RAxML/scripts/ascbias.py -p ${RAxMLallignments_path}/${RAxMLInput_name}.min4.phy -o ${RAxMLallignments_path}/${RAxMLInput_name}_RAxMLready.min4.phy
...
raxml-ng --all --msa ${RAxMLallignments_path}/${RAxMLInput_name}_RAxMLready.min4.phy --model GTR+G+ASC_LEWIS --tree pars{10} --bs-trees 100 --threads 52 --workers auto --seed 12345 --prefix ${RAxMLInput_name}_RAxMLout
