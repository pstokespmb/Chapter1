...
#SBATCH -J RAxML_prepAndRun_noLowCov_newVersionRAxML_GTGTR4
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/RAxML_prepAndRun_noLowCov_newVersionRAxML_GTGTR4.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/RAxML_prepAndRun_noLowCov_newVersionRAxML_GTGTR4.err
...
VCFInput_name="Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure"
VCFThinnedPrefix_name="Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure_Thinned"

RAxMLallignments_path="/global/scratch/users/peter_stokes/Chapter1/RAxML/alignments"
RAxMLInput_name="Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G1_M5_LD_Pruned_forDStats_forPCA_forfastStructure"
RAxMLouts_path="/global/scratch/users/peter_stokes/Chapter1/RAxML/outs"

#Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure.vcf
...
#Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure_Thinned_5k_RAxMLready.min4.phy

#raxml-ng --all --msa ${RAxMLallignments_path}/Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure_Thinned_20k_RAxMLready.min4.phy --model GTR+G+ASC_LEWIS --tree pars{10} --bs-trees 100 --threads 52 --workers auto --seed 12345 --prefix Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure_Thinned_20k_RAxMLready_RAxMLout

raxml-ng --all --msa ${RAxMLallignments_path}/Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure_Thinned_1k_RAxMLready.min4.phy --model GTR+G+ASC_LEWIS --tree pars{10} --bs-trees 100 --threads 52 --workers auto --seed 12345 --prefix Chapter1_allChrom_noRR_NF_noED_noLowCov_noInterIntraAdmix_noBadMexCult_wMexWild_D4_Bi_plinked_G2_M5_LD_Pruned_forDStats_forPCA_forfastStructure_Thinned_1k_RAxMLready_RAxMLout
