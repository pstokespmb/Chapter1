...
#SBATCH -J 4_LRE_ENA_vcf2smc_Chr09_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/4_LRE_ENA_vcf2smc_Chr09_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/4_LRE_ENA_vcf2smc_Chr09_test.err
