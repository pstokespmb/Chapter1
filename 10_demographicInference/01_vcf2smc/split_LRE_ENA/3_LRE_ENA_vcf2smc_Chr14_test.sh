...
#SBATCH -J 3_LRE_ENA_vcf2smc_Chr14_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_LRE_ENA_vcf2smc_Chr14_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_LRE_ENA_vcf2smc_Chr14_test.err
...
for sample in Mandan1_PPN046;
    ...
    smc++ vcf2smc \
    --cores 1 \
    --mask /global/scratch/users/peter_stokes/Chapter1/masks_for_smcpp/InversionRegions_Chr14.bed.gz \
    -d ${sample} ${sample} \
    /global/scratch/users/peter_stokes/Chapter1/VCF_for_smcpp/PS_Chapter1_biallelicSNPS_G4_hardFilteredInvariants_Chr14_missingPosReplaced_sorted.vcf.gz \
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/LRE_ENA_${sample}_Chr14_test.smc.gz \
    HanXRQChr14 \
