...
#SBATCH -J 1_LRE_ENA_vcf2smc_Chr05_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/1_LRE_ENA_vcf2smc_Chr05_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/1_LRE_ENA_vcf2smc_Chr05_test.err
