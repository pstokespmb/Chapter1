...
#SBATCH -J 3_LRE_ENA_vcf2smc_Chr03_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_LRE_ENA_vcf2smc_Chr03_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_LRE_ENA_vcf2smc_Chr03_test.err
...
for sample in Mandan1_PPN046;
    ...
    --cores 1 \
    -d ${sample} ${sample} \
    /global/scratch/users/peter_stokes/Chapter1/VCF_for_smcpp/PS_Chapter1_biallelicSNPS_G4_hardFilteredInvariants_Chr03_missingPosReplaced_sorted.vcf.gz \
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/LRE_ENA_${sample}_Chr03_test.smc.gz \
    HanXRQChr03 \
