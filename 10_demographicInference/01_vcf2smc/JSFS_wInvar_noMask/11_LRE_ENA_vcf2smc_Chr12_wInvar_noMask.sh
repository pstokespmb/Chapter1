...
#SBATCH -J 11_LRE_ENA_vcf2smc_Chr12_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/11_LRE_ENA_vcf2smc_Chr12_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/11_LRE_ENA_vcf2smc_Chr12_wInvar_noMask.err
...
/global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/LRE_ENA_Chr12_wInvar_noMask.smc.gz \
HanXRQChr12 \
