...
#SBATCH -J 12_ENA_LRE_vcf2smc_Chr07_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/12_ENA_LRE_vcf2smc_Chr07_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/12_ENA_LRE_vcf2smc_Chr07_wInvar_noMask.err
...
/global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/ENA_LRE_Chr07_wInvar_noMask.smc.gz \
HanXRQChr07 \
