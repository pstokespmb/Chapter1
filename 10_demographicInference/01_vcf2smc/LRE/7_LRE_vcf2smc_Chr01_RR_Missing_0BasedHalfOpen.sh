...
#SBATCH -J 7_LRE_vcf2smc_Chr01_RR_Missing_0BasedHalfOpen
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr01_RR_Missing_0BasedHalfOpen.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr01_RR_Missing_0BasedHalfOpen.err
...
for sample in Hopi_real_NEW Hopi_mapping_NEW;
    do singularity exec -B /global/scratch/users/peter_stokes /global/scratch/users/peter_stokes/smcpp_latest.sif \
    smc++ vcf2smc \
    --mask /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/masks/RR_Missing_Chr01_stacked_sorted_collapsed_0BasedHalfOpen.bed.gz \
    --cores 1 \
    -d ${sample} ${sample} \
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/LRE_${sample}_Chr01_RR_Missing_0BasedHalfOpen.smc.gz \
    HanXRQChr01 \
