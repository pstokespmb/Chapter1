...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/8_LRE_vcf2smc_Chr17.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/8_LRE_vcf2smc_Chr17.err
