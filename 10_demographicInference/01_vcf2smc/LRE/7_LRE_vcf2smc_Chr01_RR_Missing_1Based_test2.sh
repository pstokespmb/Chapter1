...
#SBATCH -J 7_LRE_vcf2smc_Chr01_RR_Missing_1Based_test2
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr01_RR_Missing_1Based_test2.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr01_RR_Missing_1Based_test2.err
...
for sample in Hopi_real_NEW Hopi_mapping_NEW;
    ...
    smc++ vcf2smc \
    --mask /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/masks/RR_Missing_Chr01_1Based_stacked_sorted_collapsed.bed.gz \
    --cores 1 \
    -d ${sample} ${sample} \
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/LRE_${sample}_Chr01_RR_Missing_1Based_test2.smc.gz \
    HanXRQChr01 \
