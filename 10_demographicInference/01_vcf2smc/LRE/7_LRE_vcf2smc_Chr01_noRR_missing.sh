...
#SBATCH -J 7_LRE_vcf2smc_Chr01_noRR_missing
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr01_noRR_missing.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr01_noRR_missing.err
...
for sample in Hopi_real_NEW Hopi_mapping_NEW;
    ...
    smc++ vcf2smc \
    --mask /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/masks/noRR_Missing_sorted_merged.bed.gz \
    --cores 1 \
    -d ${sample} ${sample} \
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/LRE_${sample}_Chr01_noRR_missing.smc.gz \
    HanXRQChr01 \
