...
#SBATCH -J 6_LRE_vcf2smc_Chr17_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/6_LRE_vcf2smc_Chr17_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/6_LRE_vcf2smc_Chr17_test.err
...
for sample in Arikara Hidatsa Mandan1_PPN046;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/LRE_${sample}_Chr17_test.smc.gz \
    HanXRQChr17 \
