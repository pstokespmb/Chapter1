...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/9_LRE_vcf2smc_Chr03.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/9_LRE_vcf2smc_Chr03.err
