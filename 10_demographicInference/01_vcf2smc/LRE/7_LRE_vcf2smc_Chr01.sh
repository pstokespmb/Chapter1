...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr01.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr01.err
...
for sample in Hopi_real_NEW Hopi_mapping_NEW;
    ...
    smc++ vcf2smc \
    --mask /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/masks/new_RR_Chr01.bed.gz \
    --cores 1 \
    -d ${sample} ${sample} \
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/LRE_${sample}_Chr01_RRMask.smc.gz \
    HanXRQChr01 \
