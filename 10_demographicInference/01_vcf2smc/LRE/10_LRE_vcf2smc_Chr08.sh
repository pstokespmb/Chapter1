...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/10_LRE_vcf2smc_Chr08.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/10_LRE_vcf2smc_Chr08.err
