...
#SBATCH -J 3_ENA_vcf2smc_Chr13_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_ENA_vcf2smc_Chr13_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_ENA_vcf2smc_Chr13_wInvar_noMask.err
