...
#SBATCH -J 6_ENA_vcf2smc_Chr04_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/6_ENA_vcf2smc_Chr04_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/6_ENA_vcf2smc_Chr04_wInvar_noMask.err
