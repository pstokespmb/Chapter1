...
#SBATCH -J 4_ENA_vcf2smc_Chr02_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/4_ENA_vcf2smc_Chr02_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/4_ENA_vcf2smc_Chr02_wInvar_noMask.err
