...
#SBATCH -J 2_ENA_vcf2smc_Chr09_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/2_ENA_vcf2smc_Chr09_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/2_ENA_vcf2smc_Chr09_wInvar_noMask.err
...
for sample in MO1W_38 IA1W_11R;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/ENA_${sample}_Chr09_wInvar_noMask.smc.gz \
    HanXRQChr09 \
