...
#SBATCH -J 8_LRE_vcf2smc_Chr10_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/8_LRE_vcf2smc_Chr10_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/8_LRE_vcf2smc_Chr10_wInvar_noMask.err
