...
#SBATCH -J 9_LRE_vcf2smc_Chr09_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/9_LRE_vcf2smc_Chr09_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/9_LRE_vcf2smc_Chr09_wInvar_noMask.err
