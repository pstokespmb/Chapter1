...
#SBATCH -J 7_LRE_vcf2smc_Chr08_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr08_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/7_LRE_vcf2smc_Chr08_wInvar_noMask.err
...
for sample in Hopi_real_NEW Hopi_mapping_NEW;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/LRE_${sample}_Chr08_wInvar_noMask.smc.gz \
    HanXRQChr08 \
