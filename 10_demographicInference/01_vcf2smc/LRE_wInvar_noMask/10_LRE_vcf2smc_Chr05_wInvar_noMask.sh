...
#SBATCH -J 10_LRE_vcf2smc_Chr05_wInvar_noMask
...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/10_LRE_vcf2smc_Chr05_wInvar_noMask.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/10_LRE_vcf2smc_Chr05_wInvar_noMask.err
