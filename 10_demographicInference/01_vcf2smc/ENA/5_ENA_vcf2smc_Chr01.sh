...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/5_ENA_vcf2smc_Chr01.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/5_ENA_vcf2smc_Chr01.err
