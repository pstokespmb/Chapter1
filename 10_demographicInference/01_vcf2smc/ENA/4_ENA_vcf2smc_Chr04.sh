...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/4_ENA_vcf2smc_Chr04.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/4_ENA_vcf2smc_Chr04.err
