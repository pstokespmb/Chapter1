...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/2_ENA_vcf2smc_Chr15.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/2_ENA_vcf2smc_Chr15.err
...
for sample in MO1W_38 IA1W_11R;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/2023/vcf2smc_output/ENA_${sample}_Chr15_RRMask.smc.gz \
    HanXRQChr15 \
