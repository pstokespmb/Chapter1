...
#SBATCH -J 5_ENA_vcf2smc_Chr03_test
...
#SBATCH --mem=32000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/5_ENA_vcf2smc_Chr03_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/5_ENA_vcf2smc_Chr03_test.err
