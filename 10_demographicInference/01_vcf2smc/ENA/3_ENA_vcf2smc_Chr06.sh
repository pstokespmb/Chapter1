...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/3_ENA_vcf2smc_Chr06.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/3_ENA_vcf2smc_Chr06.err
