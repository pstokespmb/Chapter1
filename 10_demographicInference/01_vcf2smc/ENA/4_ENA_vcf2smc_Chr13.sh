...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/4_ENA_vcf2smc_Chr13.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/4_ENA_vcf2smc_Chr13.err
