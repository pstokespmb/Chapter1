...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/6_ENA_vcf2smc_Chr16.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/6_ENA_vcf2smc_Chr16.err
