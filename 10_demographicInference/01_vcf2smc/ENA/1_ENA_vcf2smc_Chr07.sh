...
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/1_ENA_vcf2smc_Chr07.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/1_ENA_vcf2smc_Chr07.err
