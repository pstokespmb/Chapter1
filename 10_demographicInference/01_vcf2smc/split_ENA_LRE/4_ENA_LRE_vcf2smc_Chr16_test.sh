...
#SBATCH -J 4_ENA_LRE_vcf2smc_Chr16_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/4_ENA_LRE_vcf2smc_Chr16_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/4_ENA_LRE_vcf2smc_Chr16_test.err
