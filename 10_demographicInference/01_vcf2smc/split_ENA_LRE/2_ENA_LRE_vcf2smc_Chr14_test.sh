...
#SBATCH -J 2_ENA_LRE_vcf2smc_Chr14_test
...
#SBATCH --mem=9600
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/2_ENA_LRE_vcf2smc_Chr14_test.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/2_ENA_LRE_vcf2smc_Chr14_test.err
...
for sample in Ann1238_subset;
    ...
    /global/scratch/users/peter_stokes/Chapter1/smcpp/vcf2smc_output/ENA_LRE_${sample}_Chr14_test.smc.gz \
    HanXRQChr14 \
