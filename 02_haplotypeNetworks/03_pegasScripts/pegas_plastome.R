...
# <- read.xlsx("HaploNaming_PeterStokes.xlsx", sheetName = "Pop_art_import")
...
write.dna(Matrix_haplotypes_good, file = "Plastome_SNPs_88.fasta", format = "fasta", colsep = "", nbcol = -1)
