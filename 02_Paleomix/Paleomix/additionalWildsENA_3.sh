...
#SBATCH --mem=64000
#SBATCH -o /global/scratch/users/peter_stokes/err_outs/additionalWildsENA_3.out
#SBATCH -e /global/scratch/users/peter_stokes/err_outs/additionalWildsENA_3.err
