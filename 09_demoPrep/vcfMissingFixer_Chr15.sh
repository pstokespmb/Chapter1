...
bcftools sort -T /global/scratch/users/peter_stokes/temp_files/Chr15 PS_Chapter1_biallelicSNPS_G4_hardFilteredInvariants_Chr15_missingPosReplaced_unsorted.vcf.gz -Oz -o PS_Chapter1_biallelicSNPS_G4_hardFilteredInvariants_Chr15_missingPosReplaced_sorted.vcf.gz
